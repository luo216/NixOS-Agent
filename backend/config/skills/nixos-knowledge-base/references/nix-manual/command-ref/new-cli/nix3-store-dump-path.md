---
title: "nix store dump-path - Nix 2.28.6 Reference Manual"
source: command-ref/new-cli/nix3-store-dump-path.html
---

# nix store dump-path - Nix 2.28.6 Reference Manual
