---
title: "nix store path-from-hash-part - Nix 2.28.6 Reference Manual"
source: command-ref/new-cli/nix3-store-path-from-hash-part.html
---

# nix store path-from-hash-part - Nix 2.28.6 Reference Manual
