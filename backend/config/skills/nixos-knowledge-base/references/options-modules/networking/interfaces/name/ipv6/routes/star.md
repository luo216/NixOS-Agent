---
module: networking.interfaces.<name>.ipv6.routes.*
option_count: 5
source: options.html
---
...
IPv6 address of the network. Type: string Declared by: <nixpkgs/nixos/modules/tasks/network-interfaces.nix>
...
Subnet mask of the network, specified as the number of bits in the prefix (64). Type: integer between 0 and 128 (both inclusive) Declared by: <nixpkgs/nixos/modules/tasks/network-interfaces.nix>
...
IPv6 address of the next hop. Type: null or string Default: null Declared by: <nixpkgs/nixos/modules/tasks/network-interfaces.nix>
