---
module: systemd.tmpfiles.settings.<config-name>.<path>.<tmpfiles-type>
option_count: 6
source: options.html
---

# systemd.tmpfiles.settings.<config-name>.<path>.<tmpfiles-type>

## systemd.tmpfiles.settings.<config-name>.<path>.<tmpfiles-type>.age
...
## systemd.tmpfiles.settings.<config-name>.<path>.<tmpfiles-type>.argument
...
## systemd.tmpfiles.settings.<config-name>.<path>.<tmpfiles-type>.group
