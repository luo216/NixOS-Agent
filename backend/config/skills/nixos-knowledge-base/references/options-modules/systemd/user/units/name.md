---
module: systemd.user.units.<name>
option_count: 8
source: options.html
---

# systemd.user.units.<name>
...
Text of this systemd unit. Type: null or string Default: null Declared by: <nixpkgs/nixos/modules/system/boot/systemd/user.nix>
