---
module: systemd.user.slices.<name>
option_count: 26
source: options.html
---
...
Each attribute in this set specifies an option in the [Slice] section of the unit. See systemd.slice(5) for details. Type: attribute set of (systemd option) Default: { } Example: { MemoryMax = "2G"; } Declared by: <nixpkgs/nixos/modules/system/boot/systemd/user.nix>
