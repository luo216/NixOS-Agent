---
module: services.sftpgo.settings.ftpd.bindings.*
option_count: 2
source: options.html
---
...
The port for serving FTP requests. Setting the port to 0 disables listening on this interface binding. Type: 16 bit unsigned integer; between 0 and 65535 (both inclusive) Default: 0 Declared by: <nixpkgs/nixos/modules/services/web-apps/sftpgo.nix>
