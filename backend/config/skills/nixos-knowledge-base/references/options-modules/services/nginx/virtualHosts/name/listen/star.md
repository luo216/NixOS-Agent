---
module: services.nginx.virtualHosts.<name>.listen.*
option_count: 5
source: options.html
---
...
Listen address. Type: string Declared by: <nixpkgs/nixos/modules/services/web-servers/nginx/default.nix>
...
Port number to listen on. If unset and the listen address is not a socket then nginx defaults to 80. Type: null or 16 bit unsigned integer; between 0 and 65535 (both inclusive) Default: null Declared by: <nixpkgs/nixos/modules/services/web-servers/nginx/default.nix>
...
Enable SSL. Type: boolean Default: false Declared by: <nixpkgs/nixos/modules/services/web-servers/nginx/default.nix>
