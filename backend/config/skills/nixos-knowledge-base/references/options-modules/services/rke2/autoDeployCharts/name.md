---
module: services.rke2.autoDeployCharts.<name>
option_count: 11
source: options.html
---

# services.rke2.autoDeployCharts.<name>

## services.rke2.autoDeployCharts.<name>.enable
...
## services.rke2.autoDeployCharts.<name>.package
...
## services.rke2.autoDeployCharts.<name>.createNamespace
...
## services.rke2.autoDeployCharts.<name>.extraDeploy
...
Extra HelmChart field definitions that are merged with the rest of the HelmChart custom resource. This can be used to set advanced fields or to overwrite generated fields. See https://docs.rke2.io/helm#helmchart-field-definitions for possible fields. Type: JSON value Default: { } Example: { spec = { backOffLimit = 3; bootstrap = true; helmVersion = "v2"; jobImage = "custom-helm-controller:v0.0.1"; }; } Declared by: <nixpkgs/nixos/modules/services/cluster/rancher/default.nix>

## services.rke2.autoDeployCharts.<name>.hash
...
## services.rke2.autoDeployCharts.<name>.name
...
## services.rke2.autoDeployCharts.<name>.targetNamespace
...
## services.rke2.autoDeployCharts.<name>.values
...
## services.rke2.autoDeployCharts.<name>.version
