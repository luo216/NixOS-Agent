---
module: services.netbird.clients.<name>
option_count: 11
source: options.html
---
...
## services.netbird.clients.<name>.autoStart
...
## services.netbird.clients.<name>.environment
...
## services.netbird.clients.<name>.hardened
...
## services.netbird.clients.<name>.interface
...
## services.netbird.clients.<name>.logLevel
...
## services.netbird.clients.<name>.name
...
## services.netbird.clients.<name>.openFirewall
...
## services.netbird.clients.<name>.openInternalFirewall
...
## services.netbird.clients.<name>.port
...
## services.netbird.clients.<name>.suffixedName
