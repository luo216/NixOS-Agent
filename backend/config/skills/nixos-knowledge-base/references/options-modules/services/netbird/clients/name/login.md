---
module: services.netbird.clients.<name>.login
option_count: 3
source: options.html
---

# services.netbird.clients.<name>.login

## services.netbird.clients.<name>.login.enable
...
## services.netbird.clients.<name>.login.setupKeyFile
...
## services.netbird.clients.<name>.login.systemdDependencies
